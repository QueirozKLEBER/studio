...
export const exercises: Record<string, Exercise[]> = {
  ...
  trapezio: [
    ...
    createEx('remada-alta-trap', 'Remada Alta com Barra', 'Trapézio', 'Barra', 'Intermediário'),
  ...
  ombros: [
    ...
    createEx('eleva-frontal-alt', 'Elevação Frontal Alternada', 'Ombros', 'Halteres', 'Iniciante'),
    ...
    createEx('desenv-nuca', 'Desenvolvimento atrás da nuca (Uso restrito)', 'Ombros', 'Barra', 'Avançado'),
    ...
    createEx('eleva-lat-uni-cabo', 'Elevação Lateral Unilateral no Cabo', 'Ombros', 'Cabo/Polia', 'Intermediário'),
  ...
  biceps: [
    ...
    createEx('rosca-elastico', 'Rosca com Elástico', 'Bíceps', 'Elástico', 'Iniciante'),
    createEx('chin-up', 'Chin-up (Barra Fixa Supinada)', 'Bíceps', 'Peso do corpo', 'Intermediário'),
    createEx('rosca-pe-uni', 'Rosca em pé unilateral', 'Bíceps', 'Halteres', 'Iniciante'),
    createEx('rosca-45-graus', 'Rosca em 45 graus', 'Bíceps', 'Halteres', 'Intermediário'),
    createEx('rosca-neutra', 'Rosca com Pegada Neutra', 'Bíceps', 'Halteres', 'Iniciante'),
    createEx('rosca-fechada', 'Rosca com Pegada Fechada', 'Bíceps', 'Barra', 'Intermediário'),
  ],
  triceps: [
    ...
    createEx('ext-uni-cabo', 'Extensão unilateral no cabo', 'Tríceps', 'Cabo/Polia', 'Intermediário'),
    ...
    createEx('triceps-banco-inc', 'Tríceps em banco inclinado', 'Tríceps', 'Halteres', 'Intermediário'),
    createEx('triceps-reversa', 'Tríceps com Pegada Reversa', 'Tríceps', 'Cabo/Polia', 'Intermediário'),
    createEx('triceps-isometrico', 'Tríceps Isométrico', 'Tríceps', 'Halteres', 'Avançado'),
  ],
  pernas: [
    ...
    createEx('step-up', 'Step-up', 'Pernas', 'Livre', 'Intermediário'),
    ...
    createEx('good-morning-perna', 'Good Morning', 'Pernas', 'Barra', 'Avançado'),
    ...
    createEx('abducao-quadril-maq', 'Abdução de Quadril Máquina', 'Pernas', 'Máquina', 'Iniciante'),
    createEx('aducao-quadril-maq', 'Adução de Quadril Máquina', 'Pernas', 'Máquina', 'Iniciante'),
    createEx('eleva-pelvica-uni', 'Elevação Pélvica Unilateral', 'Pernas', 'Peso do corpo', 'Intermediário'),
    ...
    createEx('agachamento-pausa', 'Agachamento com Pausa', 'Pernas', 'Barra', 'Avançado'),
    createEx('nordic-curl', 'Nordic Curl', 'Pernas', 'Peso do corpo', 'Avançado'),
    createEx('swing-kettlebell', 'Swing com Kettlebell', 'Pernas', 'Kettlebell', 'Intermediário'),
    createEx('deadlift-sumo-perna', 'Deadlift Sumô', 'Pernas', 'Barra', 'Avançado'),
    createEx('deadlift-uni', 'Deadlift Unilateral', 'Pernas', 'Halteres', 'Avançado'),
    createEx('eleva-gluteo-cabo', 'Elevação de Glúteo no Cabo', 'Pernas', 'Cabo/Polia', 'Intermediário'),
    ...
    createEx('curtsy-lunge', 'Curtsy lunge', 'Pernas', 'Halteres', 'Intermediário'),
  ],
  panturrilha: [
    ...
    createEx('panturrilha-donkey', 'Panturrilha no Donkey', 'Panturrilha', 'Máquina', 'Avançado'),
    createEx('panturrilha-halter', 'Panturrilha com Halter', 'Panturrilha', 'Halteres', 'Iniciante'),
    createEx('panturrilha-cabo', 'Panturrilha no Cabo', 'Panturrilha', 'Cabo/Polia', 'Intermediário'),
  ],
  abdomen: [
    ...
    createEx('elev-pernas-banco', 'Elevação de Pernas no Banco', 'Abdômen', 'Peso do corpo', 'Iniciante'),
    createEx('prancha', 'Prancha Isométrica', 'Abdômen', 'Peso do corpo', 'Iniciante'),
    createEx('prancha-lateral', 'Prancha Lateral', 'Abdômen', 'Peso do corpo', 'Iniciante'),
    ...
    createEx('toes-to-bar', 'Toes to bar', 'Abdômen', 'Peso do corpo', 'Avançado'),
    createEx('mountain-climber', 'Mountain Climber', 'Abdômen', 'Peso do corpo', 'Intermediário'),
    createEx('dead-bug', 'Dead bug', 'Abdômen', 'Peso do corpo', 'Iniciante'),
    createEx('hollow-body', 'Hollow body', 'Abdômen', 'Peso do corpo', 'Avançado'),
    createEx('woodchopper', 'Woodchopper no Cabo', 'Abdômen', 'Cabo/Polia', 'Intermediário'),
    createEx('abd-canivete', 'Abdominal canivete', 'Abdômen', 'Peso do corpo', 'Intermediário'),
    createEx('abd-halter', 'Abdominal com halter', 'Abdômen', 'Halteres', 'Intermediário'),
    createEx('abd-dec', 'Abdominal declinado', 'Abdômen', 'Peso do corpo', 'Iniciante'),
    createEx('abd-rot', 'Abdominal com rotação', 'Abdômen', 'Livre', 'Intermediário'),
    createEx('prancha-elev-perna', 'Prancha com elevação de perna', 'Abdômen', 'Peso do corpo', 'Intermediário'),
    createEx('prancha-braco-ext', 'Prancha com braço estendido', 'Abdômen', 'Peso do corpo', 'Iniciante'),
    createEx('prancha-din', 'Prancha dinâmica', 'Abdômen', 'Peso do corpo', 'Intermediário'),
  ],
  antebreaco: [
    ...
    createEx('pegada-estatica', 'Pegada estática na barra', 'Antebraço', 'Peso do corpo', 'Intermediário'),
    createEx('wrist-roller', 'Wrist Roller', 'Antebraço', 'Livre', 'Intermediário'),
    createEx('pron-sup-halter', 'Pronação e supinação com halter', 'Antebraço', 'Halteres', 'Intermediário'),
    createEx('hang-barra', 'Hang na Barra', 'Antebraço', 'Peso do corpo', 'Intermediário'),
    createEx('flex-punho-cabo', 'Flexão de punho no cabo', 'Antebraço', 'Cabo/Polia', 'Intermediário'),
    createEx('ext-punho-cabo', 'Extensão de punho no cabo', 'Antebraço', 'Cabo/Polia', 'Intermediário'),
  ],
};
