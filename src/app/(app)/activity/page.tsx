  ...
  return (
    <div className="flex flex-col gap-8 pb-20 max-w-4xl mx-auto w-full">
      ...
      <Card className="rounded-[2.5rem] border-none shadow-md bg-white overflow-hidden">
        <CardHeader>
          <CardTitle className="text-xl font-black uppercase tracking-tight">O que você fez hoje?</CardTitle>
          <CardDescription>Mantenha seu personal informado sobre sua rotina fora da musculação.</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSave} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <Label className="font-bold text-xs uppercase opacity-70">Tipo de Atividade</Label>
              ...
              <div className="space-y-2">
                <Label className="font-bold text-xs uppercase opacity-70">Duração (minutos)</Label>
                <div className="relative">
                  ...
                  <Input 
                    ...
                    className="rounded-xl h-12 pl-10 bg-muted/30 border-none"
                  />
                </div>
              </div>

              <div className="space-y-2">
                <Label className="font-bold text-xs uppercase opacity-70">Intensidade</Label>
            ...
            <div className="space-y-2">
              <Label className="font-bold text-xs uppercase opacity-70">Observações para o Professor</Label>
              <Textarea 
                placeholder="Ex: Corri na praia em jejum, me senti bem." 
            ...
            <Button 
              type="submit" 
              className="w-full h-14 rounded-2xl font-black text-lg bg-primary shadow-lg shadow-primary/20 transition-transform active:scale-95"
              disabled={isSaving}
            >
