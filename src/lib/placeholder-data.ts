...
export const exercises: Record<string, Exercise[]> = {
  peito: [
    ...
    createEx('supino-pegada-neutra', 'Supino com Pegada Neutra', 'Peito', 'Halteres', 'Intermediário'),
  ...
  costas: [
    ...
    createEx('pullover-maq', 'Pullover na Máquina', 'Costas', 'Máquina', 'Intermediário'),
    ...
    createEx('terra-romeno-costas', 'Terra Romeno', 'Costas', 'Barra', 'Avançado'),
    createEx('terra-sumo-costas', 'Terra Sumô', 'Costas', 'Barra', 'Avançado'),
  ...
  biceps: [
    ...
    createEx('rosca-inversa-biceps', 'Rosca Inversa', 'Bíceps', 'Barra', 'Intermediário', ['Antebraço']),
  ...
  triceps: [
    ...
    createEx('mergulho-banco-triceps', 'Mergulho em Banco', 'Tríceps', 'Peso do corpo', 'Iniciante'),
  ...
  trapezio: [
    ...
    createEx('shrug-atras', 'Shrug atrás', 'Trapézio', 'Smith', 'Avançado'),
    createEx('shrug-unilateral', 'Shrug Unilateral', 'Trapézio', 'Halteres', 'Intermediário'),
  ],
  lombar: [
    createEx('hiperextensao', 'Hiperextensão', 'Lombar', 'Máquina', 'Iniciante'),
    createEx('lev-terra-lombar', 'Levantamento Terra', 'Lombar', 'Barra', 'Avançado'),
