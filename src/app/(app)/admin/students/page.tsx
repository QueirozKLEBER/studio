...
import { ArrowRight, User, ShieldBan, ShieldCheck, Loader2, UserPlus, GraduationCap } from 'lucide-react';
...
export default function AdminStudentsPage() {
  ...
  // Queries filtradas por userType
  ...
  const handleAssignTrainer = async () => {
    ...
    try {
      ...
      toast({ 
        ...
        description: "O aluno agora aparecerá no painel do professor selecionado." 
      });
  ...
  return (
    <div className="flex flex-col gap-8 w-full max-w-none pb-20">
      <PageHeader 
        ...
        subtitle="Controle global e vinculação de alunos a professores da plataforma." 
      />
              ...
              <CardContent className="p-5 flex flex-col lg:flex-row items-center justify-between gap-6">
                ...
                <div className="flex flex-wrap items-center gap-3 w-full lg:w-auto justify-end">
                    ...
                    <DialogTrigger asChild>
                      <Button 
                        ...
                        onClick={() => {
                          ...
                          setSelectedTrainerId(student.trainerId || "");
                        }}
                      >
                      ...
                      <div className="py-6 space-y-4">
                        ...
                        <Select onValueChange={setSelectedTrainerId} value={selectedTrainerId}>
                          ...
                          <SelectContent className="rounded-2xl bg-card border-white/10 text-white">
                            {isLoadingTrainers ? (
                              <div className="p-4 text-center"><Loader2 className="animate-spin h-4 w-4 inline mr-2" /> Carregando...</div>
                  ...
                  <Button 
                    variant="outline" 
                    size="sm" 
                    className="rounded-xl border-white/10 hover:bg-primary hover:border-primary transition-all font-black text-[9px] uppercase min-w-[100px]"
