...
export const exercises: Record<string, Exercise[]> = {
  ...
  ombros: [
    ...
    createEx('desenvolvimento-militar-barra', 'Desenvolvimento Militar com Barra', 'ombros', 'Barra', 'Empurrar', 'Avançado'),
  ...
  biceps: [
    ...
    createEx('rosca-alternada-halter', 'Rosca Alternada com Halteres', 'biceps', 'Halteres', 'Isolar', 'Iniciante'),
    createEx('rosca-concentrada', 'Rosca Concentrada', 'biceps', 'Halteres', 'Isolar', 'Intermediário'),
    createEx('rosca-martelo-halter-biceps', 'Rosca Martelo com Halteres', 'biceps', 'Halteres', 'Isolar', 'Iniciante'),
    createEx('rosca-scott-maquina', 'Rosca Scott na Máquina', 'biceps', 'Máquina', 'Isolar', 'Intermediário'),
  ],
  triceps: [
    createEx('triceps-pulley', 'Tríceps Pulley (Corda ou Barra)', 'triceps', 'Cabo/Polia', 'Isolar', 'Iniciante'),
    createEx('triceps-testa-barra', 'Tríceps Testa com Barra', 'triceps', 'Barra', 'Isolar', 'Intermediário'),
    createEx('triceps-banco', 'Mergulho no Banco (Dips)', 'triceps', 'Peso do corpo', 'Empurrar', 'Iniciante'),
    createEx('triceps-frances-halter', 'Tríceps Francês com Halter', 'triceps', 'Halteres', 'Isolar', 'Intermediário'),
    createEx('triceps-coice-polia', 'Tríceps Coice na Polia', 'triceps', 'Cabo/Polia', 'Isolar', 'Intermediário'),
  ],
  panturrilha: [
