      ...
      <form className="space-y-6" onSubmit={handleLogin}>
        <div className="space-y-2">
          ...
          <Input 
            ...
            disabled={isLoading} 
            className="rounded-2xl h-14 border-none bg-black/20 text-white font-bold placeholder:text-white/10 px-6 focus-visible:ring-primary" 
          />
        </div>
        <div className="space-y-2">
          ...
          <Input 
            ...
            disabled={isLoading} 
            className="rounded-2xl h-14 border-none bg-black/20 text-white font-bold px-6 focus-visible:ring-primary" 
          />
        </div>
        <Button 
          type="submit" 
